  ...
  useEffect(() => {
    axios.get(`${process.env.NEXT_PUBLIC_API_URL}/products`)
      .then(res => {
        ...
        const rings = activeProducts
          .filter((p: any) => p.category === 'Rings')
      ...
      <section className="py-4 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-amber-600">Rings</span>
          </div>
        </div>
      </section>
            ...
            <aside className="lg:w-64 flex-shrink-0">
              <div className="bg-gray-50 p-6 rounded-sm mb-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="/jewellery/rings" className="block px-4 py-2 rounded-sm bg-amber-600 text-white">
