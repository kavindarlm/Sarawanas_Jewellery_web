  ...
  useEffect(() => {
    axios.get(`${process.env.NEXT_PUBLIC_API_URL}/products`)
      .then(res => {
        ...
        const chains = activeProducts
          .filter((p: any) => p.category === 'Chains')
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="https://images.unsplash.com/photo-1601821765780-754fa98637c1?w=1920"
      ...
      <section className="py-4 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-amber-600">Chains</span>
          </div>
        </div>
      </section>
            ...
            <aside className="lg:w-64 flex-shrink-0">
              <div className="bg-gray-50 p-6 rounded-sm mb-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <Link href="/jewellery/earrings" className="block px-4 py-2 rounded-sm hover:bg-gray-200 text-gray-700 transition-all">
                  ...
                  <li>
                    <Link href="/jewellery/chains" className="block px-4 py-2 rounded-sm bg-amber-600 text-white">
